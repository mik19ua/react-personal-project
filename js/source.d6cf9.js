...
var _Task = _interopRequireDefault(__webpack_require__(153));

var _Spinner = _interopRequireDefault(__webpack_require__(166));

var _reactFlipMove = _interopRequireDefault(__webpack_require__(169));

var _stylesM = _interopRequireDefault(__webpack_require__(170));

var _REST = __webpack_require__(172);
...
class Scheduler extends _react.Component {
  constructor(...args) {
    ...
    _defineProperty(this, "_setTasksFetchingState", tasksFetchingState => {
      this.setState({
    ...
    _defineProperty(this, "_createTaskAsync", async event => {
      ...
      const task = await _REST.api.createTask(this.state.newTaskMessage);
      this.setState({
        newTaskMessage: ''
      });
      this.setState(({
    ...
    _defineProperty(this, "_updateTaskAsync", async taskToUpdate => {
      ...
      this.setState(({
        ...
        newTaskMessage: '',
        tasks: (0, _instruments.sortTasksByGroup)(tasks.map(task => task.id === updatedTask[0].id ? updatedTask[0] : task))
      }));
    ...
    _defineProperty(this, "_completeAllTasksAsync", async () => {
      ...
      await _REST.api.completeAllTasks(notCompletedTasks);
      this.setState(({
        tasks
      }) => ({
        newTaskMessage: '',
  ...
  render() {
    ...
    return _react.default.createElement("section", {
      ...
      checked: false // className = { Styles.toggleTaskCompletedState }
      ,
      color1: "#363636",
      color2: "#fff",
...
var _Edit = _interopRequireDefault(__webpack_require__(161));

var _Star = _interopRequireDefault(__webpack_require__(162));
...
const completeAllTasks = async tasks => {
  ...
  const requests = tasks.map(task => fetch(`${_config.MAIN_URL}`, {
    method: 'PUT',
    headers: {
      'Content-Type': 'application/json',
      Authorization: _config.TOKEN
...
/***/ })
/******/ ]);
//# sourceMappingURL=source.d6cf9.js.map